-- =============================================================================
-- PERFECT SUPABASE SCHEMA FOR TICKET MANAGEMENT SYSTEM
-- =============================================================================
...
BEGIN
    ...
    FROM pg_proc 
    WHERE proname IN ('generate_ticket_number', 'calculate_duration', 'update_updated_at_column', 'search_tickets');
